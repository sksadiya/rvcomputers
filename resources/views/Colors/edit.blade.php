...
<div class="row">
    <div class="col-lg-12">
        <form action="{{ route('color.update' ,$color->id)}}" id="form-edit-color"  class="form-horizontal" method="post" autocomplete="off" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" id="name" value="{{ $color->name }}"  class="form-control @error('name') is-invalid @enderror" placeholder="Name" >
                            @error('name')
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control colorpicker spectrum with-add-on @error('code') is-invalid @enderror" value="{{ $color->code }}" name="code" id="code" placeholder="Color Code">
                            @error('code')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <select name="status" id="color-status" class="form-select" style="width: 100%;" required="required"  tabindex="-1" aria-hidden="true">
                            ...
                            <option {{ $color->status == 0 ? 'selected' : '' }} value="0">In-Active</option>
                        </select>
                        </div>
                    </div> 
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#form-edit-color').on('submit', function() {
