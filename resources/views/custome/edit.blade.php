...
<div class="row" data-select2-id="select2-data-13-677b">
    <div class="col-lg-12" data-select2-id="select2-data-12-59d4">
        <form action="{{ route('customer.update',$customer->id)}}" id="form-edit-customer" method="post" autocomplete="off" enctype="multipart/form-data" data-select2-id="select2-data-form-add-seller">
        @csrf    
        <div class="card" data-select2-id="select2-data-11-rdej">
                <div class="card-body" data-select2-id="select2-data-10-kw70">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $customer->name}}" placeholder="Name" >
                            @error('name')
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $customer->email}}" placeholder="Email" >
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="mobile_number" class="form-control @error('mobile_number') is-invalid @enderror" placeholder="Mobile No." value="{{ $customer->contact}}" >
                            @error('mobile_number')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                                ...
                                <div class="col-sm-3">
                                    <div class="img-div text-center btn-logo" id="btn-select-logo" data-column="logo">  <span class="text-blue cursor-pointer img-logo" style="display: none;">Choose logo</span>
                                        <span id="btn-select-icon" data-column="logo">
                                            <img id="img-logo" src="{{ $customer->avatar ? $customer->avatar : asset('assets/images/avatar.webp') }}" title="Choose logo" class="logo-display mx-auto img-fluid">
                                        </span>
                                        <input type="hidden" name="avatar" id="logo" value="{{ $customer->avatar }}">
