            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" value="{{ $state->name }}" class="form-control @error('name') is-invalid @enderror" placeholder="Name" >
                            @error('name')
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <select name="status" id="state_status" class="form-select" style="width: 100%;" required="required">
                            ...
                            <option {{($state->status == 0 ? 'selected' : '')}} value="0">In-Active</option>
                        </select>
                        </div>
                    </div>  
                </div>
