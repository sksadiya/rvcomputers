  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
                    <div class="col-sm-9">
                        <h4 class="card-title mb-4">Manage Products</h4>
                    </div>
          ...
          <div class="table-responsive">
            <table  width="100%"class="table table-bordered table-striped table-hover" id="productTable">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Image</th>
...
$('#productTable tbody').on('click', '.product_status_change', function (e) {
    e.preventDefault();
