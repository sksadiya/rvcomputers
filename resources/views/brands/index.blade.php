  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
                    <div class="col-sm-9">
                        <h4 class="card-title mb-4">Manage Brands</h4>
                    </div>
          ...
          <div class="table-responsive">
            <table  width="100%"class="table table-bordered table-striped table-hover" id="brandTable">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Name</th>
...
$('#brandTable tbody').on('click', 'button', function () {
...
$('#brandTable tbody').on('click', '.brand_status_change', function (e) {
    e.preventDefault();
