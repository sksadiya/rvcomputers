...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Add New Slider</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <form action="{{ route('slider.store' )}}" id="form-add-slider" method="post" autocomplete="off" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row mb-3 slider-type-product" style="display: none;">
                    ...
                    <div class="form-group row mb-3 slider-type-category" style="display: none;">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="link" value="{{ old('link')}}" class="form-control @error('link') is-invalid @enderror" placeholder="Link" >
                            @error('link')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#form-add-slider').on('submit', function() {
