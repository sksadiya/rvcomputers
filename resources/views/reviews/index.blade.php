  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
                    <div class="col-sm-9">
                        <h4 class="card-title mb-4">Manage Reviews</h4>
                    </div>
                </div>
          <div class="table-responsive">
            <table  width="100%"class="table table-bordered table-striped table-hover" id="reviewsTable">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Name</th>
...
$('#reviewsTable tbody').on('click', 'button', function () {
...
$('#reviewsTable tbody').on('click', '.review_status_change', function (e) {
    e.preventDefault();
