        ...
        <div class="container">
          <div class="row mb-100 justify-content-center align-items-center">
            <div class="col-lg-6">
              ...
              <form action="{{ route('customer.processRegister')}}" method="post" id="register-customer">
              @csrf
                <div class="form-register mt-30 mb-20">
                    <div class="form-group">
                    <label class="mb-2 font-sm text-black">Full Name *</label>
                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" placeholder="Steven job" required>
                    @error('name')
                    ...
                    <input class="form-control @error('password') is-invalid @enderror" type="password" name="password_confirmation" id="password_confirmation" placeholder="******************" required>
                    @error('password')
                    <span class="invalid-feedback" role="alert">
                        {{ $message }}
                    </span>
                    ...
                    <div class="form-group">
                    <button type="submit" id="btn-save-register" class="font-md-bold btn btn-buy">
                            <span class="spinner-border spinner-border-sm" id="btn-register-spinner" style="display: none;"></span>
...
<script>
    $(document).ready(function() {
        $('#register-customer').on('submit', function() {
            $('#btn-save-register').prop('disabled', true);
            $('#btn-register-spinner').show();
            $('#btn-register-text').text('Registering...');
        });
